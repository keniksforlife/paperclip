...
export const workspaceRuntimeServices = pgTable("workspace_runtime_services", {
    ...
    companyWorkspaceStatusIdx: index("workspace_runtime_services_company_workspace_status_idx").on(table.companyId, table.projectWorkspaceId, table.status),
    companyProjectStatusIdx: index("workspace_runtime_services_company_project_status_idx").on(table.companyId, table.projectId, table.status),
...
//# sourceMappingURL=workspace_runtime_services.js.map